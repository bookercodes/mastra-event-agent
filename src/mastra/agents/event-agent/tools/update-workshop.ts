...
const updateWorkshopTool = createTool({
  id: 'update-workshop',
  description: 'Update a workshop event in Luma and its corresponding Sanity document using a complete, non-null snapshot of current values plus requested changes',
